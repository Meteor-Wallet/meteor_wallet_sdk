...
interface IONearBlocks_GqlQuery_GetRelatedTransactionsWithActions_Input {
...
interface IONearBlocks_GqlQuery_GetRelatedTransactionsWithActions_Output {
...
export const nearBlocks_api1_gqlQuery_getRelatedTransactionsWithActions = {
  query,
  executeQuery: (
    inputs: IONearBlocks_GqlQuery_GetRelatedTransactionsWithActions_Input,
  ): Promise<IONearBlocks_GqlQuery_GetRelatedTransactionsWithActions_Output> =>
