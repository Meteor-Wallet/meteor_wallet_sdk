...
import type { DeployGlobalContractForm } from "../types";

export function DeployGlobalContractFields(props: {
  value: DeployGlobalContractForm;
  onChange: (next: DeployGlobalContractForm) => void;
}) {
    ...
    <div className={"flex flex-col gap-2"}>
      ...
      <div className={"input-group"}>
        ...
        <select
          ...
          onChange={(e) =>
            onChange({ ...value, deployMode: e.target.value as "AccountId" | "CodeHash" })
          }
        >
