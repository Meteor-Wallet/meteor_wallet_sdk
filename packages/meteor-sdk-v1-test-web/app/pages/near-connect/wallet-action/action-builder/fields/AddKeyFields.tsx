      ...
      <div className={"grid grid-cols-1 md:grid-cols-2 gap-3"}>
        ...
        <div className={"input-group"}>
          ...
          <input
            className={"input-text"}
            value={value.nonce}
            onChange={(e) => onChange({ ...value, nonce: e.target.value })}
          />
        </div>
        <div className={"input-group"}>
          ...
          <select
            ...
            onChange={(e) =>
              onChange({
                ...value,
                permissionType: e.target.value as "FullAccess" | "FunctionCall",
              })
            }
          >
        ...
        <div className={"flex flex-col gap-2"}>
          <div className={"input-group"}>
            ...
            <input
              ...
              onChange={(e) => onChange({ ...value, receiverId: e.target.value })}
            />
          </div>
          <div className={"grid grid-cols-1 md:grid-cols-2 gap-3"}>
            <div className={"input-group"}>
              ...
              <input
                className={"input-text"}
                value={value.allowanceNear}
                onChange={(e) => onChange({ ...value, allowanceNear: e.target.value })}
              />
            </div>
            <div className={"input-group"}>
              ...
              <input
                className={"input-text"}
                value={value.allowanceYocto}
                onChange={(e) => onChange({ ...value, allowanceYocto: e.target.value })}
              />
            </div>
          </div>
          <div className={"input-group"}>
            ...
            <input
              className={"input-text"}
              value={value.methodNamesCsv}
              onChange={(e) => onChange({ ...value, methodNamesCsv: e.target.value })}
            />
          </div>
        </div>
      )}
